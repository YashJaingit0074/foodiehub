...
with nav_col1:
    st.link_button("🎛️ Control Center", "http://localhost:8510", use_container_width=True)

with nav_col2:
    st.link_button("🍕 Customer Panel", "http://localhost:8508", use_container_width=True)
    st.caption("🔑 Password: admin123")

with nav_col3:
    st.link_button("📊 Analytics Dashboard", "http://localhost:8501", use_container_width=True)

with nav_col4:
    st.info("🔐 Current Panel")
